<?php
    ...
    if(isset($_POST['nombre'])) {
        ...
        try {
            ...
            $mail->Subject = 'New message from ' . $name . ' [' . $service . ']';
            $mail->Body    = 'Name: ' . $name . '<br>Email: ' . $email . '<br>Phone: ' . $phone . '<br>Service: ' . $service . '<br><br>This message was sent through one of the contact forms on King Logistic Oil\'s website.';
